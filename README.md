...
| [`Doc/05-f-车上激励与采样同步暂存.md`](Doc/05-f-车上激励与采样同步暂存.md) | 暂存：20 A 边沿、主动加热脉冲、\(I\)–\(U\) 差几毫秒；不改默认门 |
...
| [`Doc/06-d-第2期包级对照实验.md`](Doc/06-d-第2期包级对照实验.md) | 第 2 期数字：2A1 跨芯隔离已跑；2A2 / 2B 未跑 |
