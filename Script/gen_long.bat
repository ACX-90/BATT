...
::   does NOT edit SEQUENCE in nmc100ah_gen.py
...
::
:: CLI args  (nmc100ah_gen_long.py)
::   --only NAME       cc_rest | chg_park | fchg_park | schg_park | loop
::                     this file: loop
::   --no-noise        disable meas noise
::   --pybamm          PyBaMM SPM; ramps as drive cycle; writes Data/long_pybamm/
::   --thermal         with --pybamm only: lumped thermal
...
::
:: notes
::   dt / noise / ECM from nmc100ah_gen.py; only the current profile changes
